                    ...
                    <div className="col-sm-6 mobile" style={{textAlign: 'center'}}>
                        ...
                        <div className="col-sm-12 mobileForm" style={styles.bgLayer}>
                            <div className="col-sm-6 form1" style={{borderRight: '1px solid #ffffff'}}>
                                ...
                                <form style={styles.formGroup}>
                                    <div className="form-group">
                                        <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="USERNAME/EMAIL" />
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <button style={styles.btn} type="button" className="btn btn-primary">LOG IN</button>
                                </form>
                            </div>
                            <div className="col-sm-6 form2">
                                <p style={styles.textTitle}>
                                    If you don't already have an account click<br/>
                                    the button below to request an account
                                </p>
                                <form style={styles.formBtn}>
                                    <button style={styles.accountBtn} type="button" className="btn btn-primary">REQUEST ACCOUNT</button>
                                    <label style={styles.divide}>OR</label>
                                    <button style={styles.facebookBtn} type="button" className="btn btn-primary">REQUEST WITH FACEBOOK</button>
                                    <button style={styles.googleBtn} type="button" className="btn btn-primary">REQUEST WITH GOOGLE</button>
                                </form>
                            </div>
                        </div>
                        {/* <div className="col-sm-12" style={styles.footer}>
